const styles = {
  // App.js
  container: "flex justify-center min-h-screen min-w-screen sm:px-16 px-6 bg-site-black",
  innerContainer:
    "flex justify-between items-center flex-col w-full",
  innerContainerSearch:
    "block justify-between items-center flex-col w-full",
  innerContainerCoins:
    "block text-white justify-between items-center flex-col w-full",
  innerContainerAbout:
    "flex justify-between items-center flex-col w-full",
  header: "block flex-row justify-between items-center w-full sm:py-10 py-6",
  nav_header: "inline",
  exchangeContainer:
  ...
  member: "text-white font-arial font-black text-2xl",
